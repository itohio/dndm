...
func (_m *MockIntentInternal) Interest() <-chan dndm.Route {
	ret := _m.Called()
	...
	var r0 <-chan dndm.Route
	if rf, ok := ret.Get(0).(func() <-chan dndm.Route); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(<-chan dndm.Route)
		}
	}
...
func (_c *MockIntentInternal_Interest_Call) Return(_a0 <-chan dndm.Route) *MockIntentInternal_Interest_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIntentInternal_Interest_Call) RunAndReturn(run func() <-chan dndm.Route) *MockIntentInternal_Interest_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *MockIntentInternal) Route() dndm.Route {
	ret := _m.Called()
...
func (_c *MockIntentInternal_Route_Call) Return(_a0 dndm.Route) *MockIntentInternal_Route_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIntentInternal_Route_Call) RunAndReturn(run func() dndm.Route) *MockIntentInternal_Route_Call {
	_c.Call.Return(run)
	return _c
}
