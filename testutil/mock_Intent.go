...
func (_m *MockIntent) Interest() <-chan dndm.Route {
	ret := _m.Called()
...
func (_c *MockIntent_Interest_Call) Return(_a0 <-chan dndm.Route) *MockIntent_Interest_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIntent_Interest_Call) RunAndReturn(run func() <-chan dndm.Route) *MockIntent_Interest_Call {
	_c.Call.Return(run)
	return _c
}

// Route provides a mock function with given fields:
func (_m *MockIntent) Route() dndm.Route {
	ret := _m.Called()
...
func (_c *MockIntent_Route_Call) Return(_a0 dndm.Route) *MockIntent_Route_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MockIntent_Route_Call) RunAndReturn(run func() dndm.Route) *MockIntent_Route_Call {
	_c.Call.Return(run)
	return _c
}
